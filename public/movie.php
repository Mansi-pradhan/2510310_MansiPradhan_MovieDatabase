...
round(array_sum($allRatings)/$totalReviews, 1): "No ratings yet";
...
$reviewsRaw = $reviewStmt->fetchAll();
...
<body>
	...
	<p><strong>Cast:</strong><? = htmlspecialchars($movie['cast'])?></p>
